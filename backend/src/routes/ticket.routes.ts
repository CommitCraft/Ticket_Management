...
import { assignTicketSchema, createTicketSchema, replyTicketSchema, updateTicketSchema, userApprovalSchema } from '../validators/ticket.validator.js';
import { assignTicket, changeTicketStatus, createTicket, deleteTicket, getTicket, listAssignableUsers, listTickets, replyToTicket, updateTicket, userApproval } from '../controllers/ticket.controller.js';
...
ticketRouter.post('/:id/user-approval', protect, permitPermissions(PERMISSIONS.TICKET_WRITE), validateBody(userApprovalSchema), userApproval);
